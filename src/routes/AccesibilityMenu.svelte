...
<button
	...
	class="fixed top-10 rounded-full border-2 border-blue-600 bg-zinc-800 text-slate-200 p-2 text-xs"
	>ACCESIBILITY</button
>

<div
	class="bg-zinc-900 fixed top-0 text-slate-200 h-[90vh] w-auto min-w-[50%] p-4 m-4 z-[1000] rounded-xl overflow-y-auto"
>
	{#if isOpen}
		...
		<div class="flex flex-col gap-6">
			...
			<div class="flex gap-4 justify-between">
				<button class="p-3 rounded-full bg-slate-100 text-zinc-800"> Reset Settings </button>

				<button class="p-3 rounded-full bg-slate-100 text-zinc-800"> Statement </button>

				<button class="p-3 rounded-full bg-slate-100 text-zinc-800"> Hide Interface </button>
			</div>
